...
import {
    criarTipo_servicoController,
    getTipo_servicoControllerById,
    updateTipo_servicoControllerById,
    deleteTipo_servicoControllerById 
} from "../controllers/tipo_servicoController";
...
router.delete('/tipo_servico/:id', async (req: Request, res: Response) => {
    try {
        const result = await deleteTipo_servicoControllerById(req, res); // Corrigido o nome da função
