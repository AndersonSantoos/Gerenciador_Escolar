...
router.get('/servico/:id', async (req: Request, res: Response) => {
  try{
...
router.put('/servico/:id', async (req: Request, res: Response) => {
    try {
...
router.delete('/servico/:id', async (req: Request, res: Response) => {
    try {
